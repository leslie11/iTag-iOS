...
-(void) customizeMenu {
    ...
    [self setMenubarBackground:[UIColor colorWithRed:0.1 green:0.2 blue:0.1 alpha:1.0]];
    
    // Replace menu button with an IonIcon.
    [self.menuButton setTitle:nil forState:UIControlStateNormal];
//    [self.menuButton setImage:[UIImage imageNamed:@"back.png"] forState:UIControlStateNormal];
