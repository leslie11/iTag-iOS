...
- (void)viewDidLoad {
    ...
    _P3TextView.backgroundColor = [UIColor clearColor];
}
...
- (void)updatePostType
{
    ...
    [params setValue:@"P3" forKey:@"PostType"];
    [params setValue:_oneTextField.text forKey:@"text1"];
    [params setValue:_twoTextField.text forKey:@"text2"];
    [params setValue:_threeTextField.text forKey:@"text3"];
    [params setValue:_fourTextField.text forKey:@"text4"];
    //有网络才发送请求
